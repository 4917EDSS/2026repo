...
public class HopperSub extends SubsystemBase {
  ...
  // IMPORTANT: The term singulator refer to the mechanism in the hopper which forces balls into the
  // shooter.
  ...
  public HopperSub() {
    ...
    outputConfigs.Inverted =
        InvertedValue.Clockwise_Positive; // subject to change, i have no idea lol
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber(
        "Singulator Velocity", m_singulatorMotor.getVelocity().getValueAsDouble());
