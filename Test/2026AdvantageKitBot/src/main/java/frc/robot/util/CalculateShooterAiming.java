...
/** Add your docs here. */
/**
 * This class calculates the aiming angle for the shooter based on the robot's position and
 * orientation.
 */
public class CalculateShooterAiming {
  ...
  /**
   * Calculates the angle the shooter needs to turn to face the hub.
   *
   * @param robot
  ...
  public double getTimeOfFlight(
      Double range, Double elevation, Double launchVelocity, Double launchAngle) {
  ...
  public double calculateAngleatTarget(
      double range, double elevation, double launchVelocity, Double launchAngle) {
  ...
  private static Pose3d componentToField(
  ...
  private static Pose3d componentToRobot(
